...
rouille::rouille! {
    ...
    fonction remplacer_identifiant(identifiant: Identifiant) -> PeutÊtre<ArbreDeJetons> {
        soit identifiant_chaine_de_charactères = identifiant.vers_la_chaine_de_charactères();

        soit nouvelle_chaine_de_charactères = selon identifiant_chaine_de_charactères.as_str() {
            "Arf" => "Err",
            "Bien" => "Ok",
            "Chaine" => "String",
            ...
            _ => &identifiant_chaine_de_charactères,
        };

        soit nouvel_identifiant = Identifiant::nouveau(nouvelle_chaine_de_charactères, identifiant.portée());
